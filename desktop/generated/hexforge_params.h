...
static const HfScalePoint kHfSp_rb_amp[] = { { "Clean Meanie", 0.0f }, { "Crunchy McCrunchFace", 1.0f }, { "Gainzilla", 2.0f }, { "Doom Daddy", 3.0f }, { "Tangerang", 4.0f }, { "Neural", 5.0f }, { "Beardo BE", 6.0f }, { "Hi-Volt", 7.0f }, { "Chime Thirty", 8.0f }, { "Backline Plus", 9.0f }, { "Plexiglass", 10.0f }, { "Cali V", 11.0f }, { "Diamond Plate", 12.0f }, { "Tremont 15", 13.0f }, { "Blue Liner", 14.0f }, { "Citrus 200", 15.0f } };
...
static const HfScalePoint kHfSp_dr_b7k_grunt[] = { { "Fat", 0.0f }, { "Raw", 1.0f }, { "Thin", 2.0f } };
static const HfScalePoint kHfSp_dr_b7k_attack[] = { { "Flat", 0.0f }, { "Boost", 1.0f }, { "Cut", 2.0f } };
static const HfScalePoint kHfSp_dr2_b7k_grunt[] = { { "Fat", 0.0f }, { "Raw", 1.0f }, { "Thin", 2.0f } };
...
static const HfDesktopParam kHfDesktopParams[] = {
    ...
    { 217, "rb_amp", "Rig B Amp", "Rig B", 0.0f, 15.0f, 1.0f, "e", HFD_PARAM, kHfSp_rb_amp, int(sizeof(kHfSp_rb_amp)/sizeof(HfScalePoint)) },
    ...
    { 407, "dr_b7k_bass", "Drive B7K Bass", "Drive", 0.0f, 1.0f, 0.5f, "f", HFD_PARAM, nullptr, 0 },
    { 408, "dr_b7k_lomid", "Drive B7K Lo Mids", "Drive", 0.0f, 1.0f, 0.5f, "f", HFD_PARAM, nullptr, 0 },
    { 409, "dr_b7k_himid", "Drive B7K Hi Mids", "Drive", 0.0f, 1.0f, 0.5f, "f", HFD_PARAM, nullptr, 0 },
    { 410, "dr_b7k_treble", "Drive B7K Treble", "Drive", 0.0f, 1.0f, 0.5f, "f", HFD_PARAM, nullptr, 0 },
    { 411, "dr_b7k_grunt", "Drive B7K Grunt", "Drive", 0.0f, 2.0f, 1.0f, "e", HFD_PARAM, kHfSp_dr_b7k_grunt, int(sizeof(kHfSp_dr_b7k_grunt)/sizeof(HfScalePoint)) },
    { 412, "dr_b7k_attack", "Drive B7K Attack", "Drive", 0.0f, 2.0f, 0.0f, "e", HFD_PARAM, kHfSp_dr_b7k_attack, int(sizeof(kHfSp_dr_b7k_attack)/sizeof(HfScalePoint)) },
    { 413, "dr2_b7k_bass", "Drive 2 B7K Bass", "Drive 2", 0.0f, 1.0f, 0.5f, "f", HFD_PARAM, nullptr, 0 },
    { 414, "dr2_b7k_lomid", "Drive 2 B7K Lo Mids", "Drive 2", 0.0f, 1.0f, 0.5f, "f", HFD_PARAM, nullptr, 0 },
    { 415, "dr2_b7k_himid", "Drive 2 B7K Hi Mids", "Drive 2", 0.0f, 1.0f, 0.5f, "f", HFD_PARAM, nullptr, 0 },
    { 416, "dr2_b7k_treble", "Drive 2 B7K Treble", "Drive 2", 0.0f, 1.0f, 0.5f, "f", HFD_PARAM, nullptr, 0 },
    { 417, "dr2_b7k_grunt", "Drive 2 B7K Grunt", "Drive 2", 0.0f, 2.0f, 1.0f, "e", HFD_PARAM, kHfSp_dr2_b7k_grunt, int(sizeof(kHfSp_dr2_b7k_grunt)/sizeof(HfScalePoint)) },
    { 418, "dr2_b7k_attack", "Drive 2 B7K Attack", "Drive 2", 0.0f, 2.0f, 0.0f, "e", HFD_PARAM, kHfSp_dr2_b7k_attack, int(sizeof(kHfSp_dr2_b7k_attack)/sizeof(HfScalePoint)) },
    { 419, "sw_a", "Preset A", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 420, "sw_b", "Preset B", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 421, "sw_c", "Preset C", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 422, "sw_d", "Preset D", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 423, "ps_bank_up", "Bank Up", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 424, "ps_bank_dn", "Bank Down", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 425, "ps_save", "Save Preset", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 426, "ps_move_up", "Move Earlier", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 427, "ps_move_dn", "Move Later", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 428, "ps_backup", "Backup Presets", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 429, "ps_restore", "Restore Presets", "Presets", 0.0f, 1.0f, 0.0f, "t", HFD_COMMAND, nullptr, 0 },
    { 430, "ps_goto", "Go To Preset", "Presets", -1.0f, 127.0f, -1.0f, "i", HFD_COMMAND, nullptr, 0 },
    { 431, "ps_bank", "Active Bank", "Presets", 0.0f, 31.0f, 0.0f, "i", HFD_OUTPUT, nullptr, 0 },
    { 432, "ps_slot", "Active Slot", "Presets", 0.0f, 3.0f, 0.0f, "i", HFD_OUTPUT, nullptr, 0 },
    { 433, "out_auto", "Output Auto-Limit", "Output", 0.0f, 1.0f, 1.0f, "t", HFD_SETTING, nullptr, 0 },
    { 434, "in_meter", "Input Level", "", 0.0f, 1.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 435, "out_meter", "Output Level", "Output", 0.0f, 1.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 436, "out_mono", "Output Mono Sum", "Output", 0.0f, 1.0f, 1.0f, "t", HFD_SETTING, nullptr, 0 },
    { 437, "tuner_on", "Tuner", "Tuner", 0.0f, 1.0f, 0.0f, "t", HFD_SETTING, nullptr, 0 },
    { 438, "tuner_mute", "Tuner Mute", "Tuner", 0.0f, 1.0f, 0.0f, "t", HFD_SETTING, nullptr, 0 },
    { 439, "tuner_note", "Tuner Note", "Tuner", -1.0f, 11.0f, -1.0f, "i", HFD_OUTPUT, nullptr, 0 },
    { 440, "tuner_cents", "Tuner Cents", "Tuner", -50.0f, 50.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 441, "cpu_gt", "CPU Gate", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 442, "cpu_cp", "CPU Comp", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 443, "cpu_fz", "CPU Fuzz", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 444, "cpu_dr", "CPU Drive", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 445, "cpu_amp", "CPU Amp", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 446, "cpu_cab", "CPU Cab", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 447, "cpu_md", "CPU Mod", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 448, "cpu_dl", "CPU Delay", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 449, "cpu_rv", "CPU Reverb", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 450, "cpu_wh", "CPU Wah", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 451, "cpu_oc", "CPU Octave", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 452, "cpu_nail", "CPU Nail", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 453, "cpu_eq", "CPU EQ", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 454, "cpu_total", "CPU Total", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 455, "cpu_dr2", "CPU Drive 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 456, "cpu_rigb", "CPU Rig B", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 457, "cpu_gt2", "CPU Gate 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 458, "cpu_cp2", "CPU Comp 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 459, "cpu_fz2", "CPU Fuzz 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 460, "cpu_nail2", "CPU Nail 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 461, "cpu_md2", "CPU Modulation 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 462, "cpu_dl2", "CPU Delay 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 463, "cpu_rv2", "CPU Reverb 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 464, "cpu_wh2", "CPU Wah 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 465, "cpu_oc2", "CPU Octave 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 466, "cpu_eq2", "CPU EQ 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 467, "cpu_cab2", "CPU Cab 2", "CPU", 0.0f, 100.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 468, "cal_cmd", "Calibrate Command", "Calibration", 0.0f, 9.0f, 0.0f, "i", HFD_COMMAND, nullptr, 0 },
    { 469, "cal_trim_offs", "Cal Trim Offset", "Calibration", -12.0f, 12.0f, 0.0f, "db", HFD_SETTING, nullptr, 0 },
    { 470, "cal_floor_offs", "Cal Floor Offset", "Calibration", -20.0f, 20.0f, 0.0f, "db", HFD_SETTING, nullptr, 0 },
    { 471, "cal_state", "Cal State", "Calibration", 0.0f, 5.0f, 0.0f, "i", HFD_OUTPUT, nullptr, 0 },
    { 472, "cal_progress", "Cal Progress", "Calibration", 0.0f, 1.0f, 0.0f, "f", HFD_OUTPUT, nullptr, 0 },
    { 473, "out_voice", "Output Voice FRFR", "Output", 0.0f, 1.0f, 0.0f, "t", HFD_SETTING, nullptr, 0 },
    { 474, "fv_locut", "FRFR Low Cut", "Output Voice", 40.0f, 140.0f, 100.75f, "hz", HFD_SETTING, nullptr, 0 },
    { 475, "fv_prox", "FRFR Prox Dip", "Output Voice", 0.0f, 6.0f, 1.815f, "db", HFD_SETTING, nullptr, 0 },
    { 476, "fv_pres", "FRFR Pres Dip", "Output Voice", 0.0f, 6.0f, 3.225f, "db", HFD_SETTING, nullptr, 0 },
    { 477, "fv_fizz", "FRFR Fizz Tilt", "Output Voice", 0.0f, 6.0f, 2.7f, "db", HFD_SETTING, nullptr, 0 },
    { 478, "out_phase", "Output Phase Invert", "Output", 0.0f, 1.0f, 1.0f, "t", HFD_SETTING, nullptr, 0 },
    { 479, "amp_evhcomp", "Component Model (Lab)", "Amp", 0.0f, 1.0f, 0.0f, "t", HFD_SETTING, nullptr, 0 },
};
