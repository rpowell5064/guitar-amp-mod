...
static void seedFactoryPresets(HexForge* p) {
    ...
    // = measured out_level adjustment restoring RMS parity (+-0.2 dB).
    {
        ...
        static const RbSeed kRbSeeds[] = {
            ...
            { 6,1,  4, 0.48f, 0.50f, 0.60f, 0.50f, 0.40f, 0.70f, 0.40f, 0, 0.25f, 0, -0.3f},  // Skye (No Mod): identical Orange layer; -0.3 re-levels the riff-gain bump
            // Round 3 (rev 82, user: "the cardinal presets too, those are ghost"):
            { 3,2,  4, 0.50f, 0.55f, 0.50f, 0.50f, 0.45f, 0.70f, 0.40f, 0, 0.25f, 1, -1.5f},  // Cardinal Rhythm: Orange under the Cali V (INVERTED reinforces; user dial-in untouched)
            { 3,3,  4, 0.45f, 0.55f, 0.50f, 0.50f, 0.45f, 0.70f, 0.40f, 0, 0.28f, 1, +1.0f},  // Cardinal Lead: Orange under the Friedman (inverted, like Imperial Lead)
        };
        ...
        p->presets[6][1].vals[HF_AMP_GAIN] = 0.72f;
