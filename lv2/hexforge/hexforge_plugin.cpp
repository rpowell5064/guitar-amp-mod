...
static void seedFactoryPresets(HexForge* p) {
    ...
    // ── Rev 121 (2026-08-22): Solar Monolith = the USER'S on-device dial-in
    ...
    // less verb, louder out. DO NOT RETUNE.
    {
        ...
        sm.vals[HF_DR_DRIVE]         = 0.135f;
        sm.vals[HF_DR_TONE]          = 0.595f;
        sm.vals[HF_DR_LEVEL]         = 0.7325f;
        sm.vals[HF_DR_OCTAVE]        = 0.5275f;
        sm.vals[HF_AMP_GAIN]         = 0.8225f;
        sm.vals[HF_AMP_BASS]         = 0.7075f;
        sm.vals[HF_AMP_MID]          = 0.6125f;
        sm.vals[HF_AMP_TREBLE]       = 0.3725f;
        sm.vals[HF_AMP_PRESENCE]     = 0.5175f;
        sm.vals[HF_AMP_MASTER]       = 0.81f;
        sm.vals[HF_AMP_SUNN_VOL2]    = 0.7275f;
        sm.vals[HF_AMP_SUNN_BASS2]   = 0.6675f;
        sm.vals[HF_AMP_SUNN_MID2]    = 0.5675f;
        sm.vals[HF_AMP_SUNN_TREBLE2] = 0.4225f;
        sm.vals[HF_CAB_LOWCUT]       = 60.8f;
        sm.vals[HF_CAB_HIGHCUT]      = 10505.0f;
        sm.vals[HF_RV_PREDELAY]      = 10.75f;
        sm.vals[HF_RV_MIX]           = 0.20f;
        sm.vals[HF_CAB_MICPOS]       = 0.0f;
        sm.vals[HF_CAB_MICDIST]      = 0.0f;
