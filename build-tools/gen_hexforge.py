...
def amp_body(ns="amp"):
    ...
    face = ('<div class="hf-amp-face hf-face-m1">'
            ...
            + onerow(["gain", "pl_vol2", "pl_variac", "sir34", "evhcomp", "master", "sag", "channel", "resonance", "bass", "mid", "treble", "presence"])
            + '</div></div>')
