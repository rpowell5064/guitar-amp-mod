...
def cab2_body():
    ...
    groups = (agroup("CABINET", ["rb_cabvoice", "rb_lowcut", "rb_highcut", "rb_cabmix", "rb_cabspkdrive"])
              ...
              + agroup("MIC 2", ["rb_cabmic2type", "rb_cabmic2lvl", "rb_cabmic2pos", "rb_cabmic2dist", "rb_cabmic2align", "rb_cabmic2pol"]))
...
BLOCK_GROUPS = {
    ...
    "cab": [("CABINET", None, ["voice", "lowcut", "highcut", "mix", "spkdrive"]),
            ("ROOM", None, ["roomon", "roommix", "roomamt", "roomdense"]),
            ("MIC 2", None, ["mic2type", "mic2lvl", "mic2pos", "mic2dist", "mic2align", "mic2pol"])],   # primary mic placement renders as the MICPAD widget (below), not knobs
