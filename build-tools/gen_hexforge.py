...
ctrl.append(mkport("AMP_EVHCOMP", "amp_evhcomp", "5150 Component Model (Lab)", "t", 0, 1, 0, None, "Component"))
...
COND = {
    ...
    "amp_evhcomp":"c-amp-reso",          # EVH(2): component-model lab toggle
