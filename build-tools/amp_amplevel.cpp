...
enum { P_IN_L=0,P_IN_R,P_OUT_L,P_OUT_R,P_MODEL,P_GAIN,P_BASS,P_MID,P_TREBLE,P_PRES,P_MASTER,P_SAG,
       ...
       P_MV_GEQ2,P_MV_GEQ3,P_MV_GEQ4,P_MV_EQPRESET,P_CONTROL,P_NOTIFY,P_N_PORTS };
...
int main(){
    ...
    const char* names[12]={"Fender(Clean)","JCM800","EVH5150","Sunn","Rockerverb","NAM(skip)","Friedman","Hiwatt(Clean)","Vox(Clean)","Backline(Clean)","Plexi","CaliV"};
