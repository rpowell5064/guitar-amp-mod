...
int main(){
    ...
    const char* names[8]={"Fender(Clean)","JCM800","EVH5150","Sunn","Rockerverb","NAM(skip)","Friedman","Hiwatt(Clean)"};
    const bool isClean[8]={true,false,false,false,false,false,false,true};
